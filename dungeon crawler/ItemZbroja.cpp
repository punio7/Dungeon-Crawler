#include "ItemZbroja.h"

ItemZbroja::ItemZbroja()
{
	Item::Item();
	typ = ITEM_ZBROJA;
...
void ItemZbroja::ustaw_staty(int atak, int obrona, int dmg, int ochrona, int pancerz, int hp, int cw)
{
	this->atak = atak;
	this->obrona = obrona;
	this->dmg = dmg;
...
void ItemZbroja::ustaw_wymagania(int sila, int zre, int zwi, int wyt, int zyw)
{
	wymSila = sila;
	wymZre = zre;
	wymZwin = zwi;
