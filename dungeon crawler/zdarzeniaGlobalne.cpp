...
#pragma region 1: butelka w piwniczce
	case ListaZdarzenGlobalnych::ButelkaWPiwniczce:			
		...
		przedmiot=(polozenie->przedmioty)->znajdz(1201,1);
		if (przedmiot->dzwigniaStatus() == 0)
		{
			...
			playerMsg("Popychasz lekko butelkê, nieznany ci mechanizm p³ynnie wci¹ga j¹ w g³¹b stojaka. Przez chwilê s³yszysz tylko zgrzyty.\n");
			playerMsg("W œcianie przed tob¹ powstaje wg³êbienie, które nastêpnie powoli osuwa siê na bok, ukazuj¹c ukryte przejœcie.");
		}
		else
		{
			...
			playerMsg("Siêgasz g³êboko w stojak i poci¹gasz za butelkê, ta p³ynnie powraca do swojego poprzedniego po³o¿enia w akompaniamencie zgrzytów.\n");
			playerMsg("Przy wtórze g³oœnego szurania kamieni, ukryte przejœcie siê zamyka nie pozostawiaj¹c na œcianie nawet œladu swojego istnienia.");
		}
		return false;
		break;  
#pragma endregion
...
#pragma region 7: TEST NPC koniec rozmowy
	case ListaZdarzenGlobalnych::TestNpcKoniecRozmowy:
		drukuj("Z oddali s³yszysz g³os:\nTo jeszcze nie koniec!");
		return false;
		break;
#pragma endregion

#pragma region Zdarzenia z goblinami
	case ListaZdarzenGlobalnych::ZabicieSzamanaGoblinow:
...
#pragma endregion
	...
	default:
		playerMsg("|RPróbowano uruchomiæ nieznane zdarzenie globalne o id |0.", intToStr(id));
		return false;
